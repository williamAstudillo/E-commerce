...
const { Product, Category, User, Order, OrderLine, Reviews } = sequelize.models;

// Aca vendrian las relaciones
// Product.hasMany(Reviews);
// Hacemos todo con belongs to many porque es el que permite crear las tablas intermedias
